...
// import '../../features/intubacao/intubacao_section.dart';
...
class AppRoutes {
  ...
  static const String intubacao = '/intubacao';
...
class AppRouter {
  ...
  static final GoRouter router = GoRouter(
        ...
        routes: [
          GoRoute(
            ...
            pageBuilder: (context, state) => NoTransitionPage(
              key: const ValueKey('calculos-section'),
              child: const CalculosSection(
                key: ValueKey('calculos-section-widget'),
              ),
            ),
          ),
          // --- Commented for Apple review: only IMC and Creatinine Clearance ---
          // GoRoute(
          //   path: AppRoutes.pediatria,
          //   pageBuilder: (context, state) => NoTransitionPage(
          //     key: const ValueKey('pediatria-section'),
          //     child: const PediatriaSection(key: ValueKey('pediatria-section-widget')),
          //   ),
          // ),
          // GoRoute(
          //   path: AppRoutes.intubacao,
          //   pageBuilder: (context, state) => NoTransitionPage(
          //     key: const ValueKey('intubacao-section'),
          //     child: const IntubacaoSection(key: ValueKey('intubacao-section-widget')),
          //   ),
          // ),
          GoRoute(
            ...
            pageBuilder: (context, state) => NoTransitionPage(
              ...
              child: const SettingsSection(
                key: ValueKey('settings-section-widget'),
              ),
            ),
          ),
        ],
    ...
    redirect: (context, state) {
      ...
      // Commented tabs redirect to calculadoras
      if (state.uri.path == AppRoutes.pediatria ||
          state.uri.path == AppRoutes.intubacao) {
        return AppRoutes.calculadoras;
      }
      return null;
    },
...
class _MainShellState extends State<MainShell> {
  static const List<NavigationItem> _destinations = [
    ...
    //   selectedIcon: Icons.airline_stops,
    //   label: AppStrings.intubacaoTab,
    // ),
    NavigationItem(
